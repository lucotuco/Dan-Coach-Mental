                ...
                >
                    ...
                    >
                        ...
                        <Text style={styles.infoParagraph}>
                            Tomá aire profundo por la nariz…
                            Sostené un instante…
                            Exhalá rápido por la boca, como si soltaras un peso
                        </Text>
                        <Text style={styles.infoParagraph}>Hacelo otra vez:
                            Inhalá… sostené… exhalá fuerte.
                            Una tercera vez… un poco más intensa.
                            Sentí cómo tu cuerpo se enciende desde adentro.
                        </Text>
                        <Text style={styles.infoParagraph}>
                            Ahora apoyá bien los pies en el suelo.
                            Notá el contacto, la firmeza, el apoyo real.
                            Imaginá que desde la tierra sube una corriente suave de energía.
                            Una vibración ligera que despierta tus piernas, tu abdomen, tu pecho.
                        </Text>
                        <Text style={styles.infoParagraph}>
                            Llevá tus manos al abdomen.
                            Sentí cómo se mueve… cómo se activa… cómo responde.

                        </Text>
                        <Text style={styles.infoParagraph}>
                            Inhalá y repetí internamente:
                            “Estoy despierto.”

                        </Text>
                        <Text style={styles.infoParagraph}>
                            Exhalá y decí mentalmente:
                            “Vuelvo a mi centro.”


                        </Text>
                        <Text style={styles.infoParagraph}>
                            Ahora visualizá una luz brillante detrás del esternón.
                            Pequeña, pero intensa.
                            Con cada inhalación, esa luz crece.
                            Con cada exhalación, se expande por todo tu cuerpo.

                        </Text>
                        <Text style={styles.infoParagraph}>

                            Sube a la cabeza.
                            Se abre en los brazos.
                            Baja a las piernas.
                            Te llena de vida, energía y claridad.


                        </Text>
                        <Text style={styles.infoParagraph}>
                            Respirá profundo una vez más y afirmá:
                            “Estoy listo. Hoy tengo vitalidad.”
